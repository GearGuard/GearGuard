...
<head>
    ...
    <title>Garage User Settings</title>
        ...
        <div class="settings-grid">
            ...
            <div class="settings-section">
                <div class="settings-section-header">
                    <h2><i class="fas fa-warehouse icon"></i> Garage Profile</h2>
                </div>
                <div class="setting-item">
                    <div class="setting-details">
                        <div class="setting-label">Garage Information</div>
                        <div class="setting-description">Update your garage details</div>
                    </div>
                    <button class="action-button">Edit</button>
                </div>
                <div class="setting-item">
                    <div class="setting-details">
                        <div class="setting-label">Services Offered</div>
                        <div class="setting-description">Manage your service list</div>
                    </div>
