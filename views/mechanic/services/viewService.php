...
<body>
    <nav class="navMenu">
        <a href="/mechanic/services/addService" target="_self">Add New Service</a>
    ...
    <div class="services-container">
        <h2 class="title">All Mechanic Services</h2>
        <table>
            <tr>
                <th>Service Type</th>
                <th>Begin Time</th>
            ...
            <?php foreach ($services as $service): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($service['begin_timestamp']); ?></td>
                    <td><?php echo htmlspecialchars($service['end_timestamp']); ?></td>
    ...
    <script>
        function viewDetails(service) {
            ...
            content.innerHTML = `<h2>Details for Service</h2>
                <p>Service Type: ${service.service_type}</p>
                <p>Begin Time: ${service.begin_timestamp}</p>
                <p>End Time: ${service.end_timestamp}</p>
