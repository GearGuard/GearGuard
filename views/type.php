...
<body>
    <div class="selection-container">
        <div class="header">
            ...
            <h1>Let's start with telling us who you are</h1>
            <p>Choose your account type to get started with GearGuard</p>
        </div>

        <div class="options-container">
            <div class="option-card" onclick="window.location.href='/register'">
                <i class="fas fa-user"></i>
                <h2>Customer</h2>
                <p>Register as a vehicle owner or user to manage your vehicles and access services</p>
                <a>
                    <button class="select-btn">Register as Customer</button>
                </a>
            </div>

            <div class="option-card" onclick="window.location.href='/garage/register'">
